...
$app->get("/cart/:uidproduct/minus", function($idproduct){
...
$app->get("/cart/:uidproduct/remove", function($idproduct){
...
$app->post("/register", function(){
    ...
    if(User::checkLoginExist($_POST['email'])){
        User::setErrorRegister("Esse email ja esta sendo usando!");
        header("Location: /login");
        exit;
    }
...
$app->get("/boleto/:idorder", function($idorder){
	...
	$dadosboleto["endereco2"] = $order->getdescity() . $order->getdesstate() . " - " . $order->getdescontry() . " - CEP:". $order->getdeszipcode();
